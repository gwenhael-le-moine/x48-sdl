...
/*
  ...
  - changed append_str(char *buf, char *str) to append_str(char *buf, const
  char *str)
...
static char *op_str_1[16] = {
   ...
   * Class Mnemonics
   */
  (char *)"a, (d0)", (char *)"a, (d1)", (char *)"(d0), a", (char *)"(d1), a",
  (char *)"c, (d0)", (char *)"c, (d1)", (char *)"(d0), c", (char *)"(d1), c"
};
...
static char *in_str_80[32] = {
  ...
  (char *)"UNCNFG", (char *)"CONFIG", (char *)"C=ID", (char *)"SHUTDN", NULL,
  (char *)"C+P+1", (char *)"RESET", (char *)"BUSCC", NULL, NULL,
  (char *)"SREQ?", NULL,
  /*
   * Class Mnemonics
   */
  (char *)"move.s  c, out", (char *)"move.3  c, out", (char *)"move.4  in, a",
  (char *)"move.4  in, c", (char *)"uncnfg", (char *)"config", (char *)"c=id",
  (char *)"shutdn", NULL, (char *)"add.a   p+1, c", (char *)"reset",
  (char *)"buscc", NULL, NULL, (char *)"sreq?", NULL
};
...
static char *in_str_808[32] = {
   ...
   * HP Mnemonics
   */
  (char *)"INTON", NULL, NULL, (char *)"BUSCB", NULL, NULL, NULL, NULL, NULL,
  NULL, NULL, NULL, (char *)"PC=(A)", (char *)"BUSCD", (char *)"PC=(C)",
  (char *)"INTOFF",
  /*
   * Class Mnemonics
   */
  (char *)"inton", NULL, NULL, (char *)"buscb", NULL, NULL, NULL, NULL, NULL,
  NULL, NULL, NULL, (char *)"jmp     (a)", (char *)"buscd",
  ...
  switch (fn)
      ...
      switch (n)
          ...
          switch (fn)
            ...
            case 9:
              ...
              switch (disassembler_mode)
                {
                case HP_MNEMONICS:
                  sprintf (buf, (char *)"%cBIT=%d", (fn & 8) ? 'C' : 'A',
                           (fn & 1) ? 1 : 0);
                  p = append_str (out, buf);
                  p = append_tab (out);
        ...
        case 0xf:
          ...
          switch (disassembler_mode)
            {
            case HP_MNEMONICS:
              sprintf (buf, (n == 0xf) ? (char *)"%c%cEX" : (char *)"%c=%c",
                       (n == 0xd) ? 'P' : 'C', (n == 0xd) ? 'C' : 'P');
              p = append_str (out, buf);
              p = append_tab (out);
            ...
            case CLASS_MNEMONICS:
              p = append_str (out,
                              (n == 0xf) ? (char *)"exg.1" : (char *)"move.1");
              p = append_tab (out);
              sprintf (buf, (n == 0xd) ? (char *)"p, c.%d" : (char *)"c.%d, p",
                       fn);
              p = append_str (p, buf);
              break;
            default:
        ...
        case 0xa:
          ...
          switch (disassembler_mode)
            ...
            case HP_MNEMONICS:
              if (n == 2)
                {
                  sprintf (buf, (char *)"%cR%dEX.F", ((int)c < 8) ? 'A' : 'C',
                           (int)c & 7);
                }
              else if (n == 1)
                {
                  sprintf (buf, (char *)"%c=R%d.F", ((int)c < 8) ? 'A' : 'C',
                           (int)c & 7);
                }
              else
                {
    ...
    case 0xe:
      ...
      switch (disassembler_mode)
        ...
        case HP_MNEMONICS:
          p = append_str (out,
                          (fn == 0xc) ? (char *)"GOLONG" : (char *)"GOSUBL");
          p = append_tab (out);
    ...
    case 0xf:
      ...
      switch (disassembler_mode)
        ...
        case HP_MNEMONICS:
          p = append_str (out,
                          (fn == 0xc) ? (char *)"GOVLNG" : (char *)"GOSBVL");
          p = append_tab (out);
          p = append_addr (p, pc);
          break;
        case CLASS_MNEMONICS:
    ...
    case 5:
      ...
      switch (disassembler_mode)
        ...
        case HP_MNEMONICS:
          ...
          sprintf (buf, (disp == 0) ? (char *)"RTN%sC" : (char *)"GO%sC",
                   (n == 4) ? (char *)"" : (char *)"N");
          p = append_str (out, buf);
          if (disp != 0)
            {
    ...
    case 9:
      ...
      switch (disassembler_mode)
        ...
        case HP_MNEMONICS:
          ...
          p = append_field (p, fn);
          p = append_str (p, (char *)", (char*)");
          p = append_str (p, (disp == 0) ? (char *)"RTNYES"
                                         : (char *)"GOYES (char*)");
          if (disp != 0)
            {
              p = append_r_addr (p, &pc, disp, 2, 3);
        ...
        case CLASS_MNEMONICS:
          p = append_str (out, (disp == 0) ? (char *)"rt" : (char *)"b");
          p = append_str (
              p, in_str_9[((n >> 2) & 3) + 4 * c + 8 * CLASS_MNEMONICS]);
          p = append_field (p, fn);
          p = append_tab (out);
          if ((c == 0) && (n >= 8))
