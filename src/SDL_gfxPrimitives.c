...
int
fastPixelColorNolockNoclip (SDL_Surface *dst, Sint16 x, Sint16 y, Uint32 color)
{
  int bpp;
  Uint8 *p;
...
int
fastPixelRGBA (SDL_Surface *dst, Sint16 x, Sint16 y, Uint8 r, Uint8 g, Uint8 b,
               Uint8 a)
{
  Uint32 color;
...
int
fastPixelRGBANolock (SDL_Surface *dst, Sint16 x, Sint16 y, Uint8 r, Uint8 g,
                     Uint8 b, Uint8 a)
{
  Uint32 color;
...
pixelColor (SDL_Surface *dst, Sint16 x, Sint16 y, Uint32 color)
{
  ...
  if (gfxPrimitivesSinglePixel == NULL)
    {
      gfxPrimitivesSinglePixel = SDL_CreateRGBSurface (
          SDL_SWSURFACE | SDL_HWSURFACE | SDL_SRCALPHA, 1, 1, 32, 0xFF000000,
...
int
_putPixelAlpha (SDL_Surface *surface, Sint16 x, Sint16 y, Uint32 color,
                Uint8 alpha)
{
...
int
_filledRectAlpha (SDL_Surface *surface, Sint16 x1, Sint16 y1, Sint16 x2,
            ...
            for (x = x1; x <= x2; x++)
              {
                ...
                R = ((*pixel & Rmask) + ((dR - (*pixel & Rmask)) * alpha >> 8))
                    & Rmask;
                G = ((*pixel & Gmask) + ((dG - (*pixel & Gmask)) * alpha >> 8))
                    & Gmask;
                B = ((*pixel & Bmask) + ((dB - (*pixel & Bmask)) * alpha >> 8))
                    & Bmask;
                if (Amask)
                  A = ((*pixel & Amask)
...
int
HLineAlpha (SDL_Surface *dst, Sint16 x1, Sint16 x2, Sint16 y, Uint32 color)
{
...
int
VLineAlpha (SDL_Surface *dst, Sint16 x, Sint16 y1, Sint16 y2, Uint32 color)
{
  ...
  if ((color & 255) == 255)
  ...
  else
    {
      ...
      if (gfxPrimitivesHline == NULL)
        {
          gfxPrimitivesHline = SDL_CreateRGBSurface (
              SDL_SWSURFACE | SDL_HWSURFACE | SDL_SRCALPHA, w, 1, 32,
  ...
  if ((color & 255) == 255)
  ...
  else
    {
      ...
      if (gfxPrimitivesVline == NULL)
        {
          gfxPrimitivesVline = SDL_CreateRGBSurface (
              SDL_SWSURFACE | SDL_HWSURFACE | SDL_SRCALPHA, 1, h, 32,
              0xFF000000, 0x00FF0000, 0x0000FF00, 0x000000FF);
        }
...
static int
clipEncode (Sint16 x, Sint16 y, Sint16 left, Sint16 top, Sint16 right,
            Sint16 bottom)
{
  int code = 0;
  if (x < left)
...
static int
clipLine (SDL_Surface *dst, Sint16 *x1, Sint16 *y1, Sint16 *x2, Sint16 *y2)
{
  Sint16 left, right, top, bottom;
  int code1, code2;
  int draw = 0;
          ...
          Uint32 color)
{
  ...
  if ((color & 255) == 255)
  ...
  else
    {
      ...
      if (gfxPrimitivesBox == NULL)
        {
          gfxPrimitivesBox = SDL_CreateRGBSurface (
              SDL_SWSURFACE | SDL_HWSURFACE | SDL_SRCALPHA, w, h, 32,
              0xFF000000, 0x00FF0000, 0x0000FF00, 0x000000FF);
        }
...
int
lineRGBA (SDL_Surface *dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
          Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
  /* Draw */
...
int
aalineColorInt (SDL_Surface *dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
...
int
aalineColor (SDL_Surface *dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
             Uint32 color)
{
...
int
aalineRGBA (SDL_Surface *dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
            Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
  return (aalineColorInt (dst, x1, y1, x2, y2,
                          ((Uint32)r << 24) | ((Uint32)g << 16)
                              | ((Uint32)b << 8) | (Uint32)a,
                          1));
}
...
int
polygonColor (SDL_Surface *dst, Sint16 *vx, Sint16 *vy, int n, Uint32 color)
{
  int result;
  int i;
  Sint16 *x1, *y1, *x2, *y2;
...
int
polygonRGBA (SDL_Surface *dst, Sint16 *vx, Sint16 *vy, int n, Uint8 r, Uint8 g,
             Uint8 b, Uint8 a)
{
  /* Draw */
...
int
filledPolygonColor (SDL_Surface *dst, Sint16 *vx, Sint16 *vy, int n, int color)
{
  int result;
  int i;
  int y;
  ...
  for (y = miny; (y <= maxy); y++)
    {
      ...
      for (i = 0; (i < ints); i += 2)
        {
          result |= hlineColor (dst, gfxPrimitivesPolyInts[i],
...
int
filledPolygonRGBA (SDL_Surface *dst, Sint16 *vx, Sint16 *vy, int n, Uint8 r,
                   Uint8 g, Uint8 b, Uint8 a)
{
  /* Draw */
  return (filledPolygonColor (dst, vx, vy, n,
                              ((Uint32)r << 24) | ((Uint32)g << 16)
                                  | ((Uint32)b << 8) | (Uint32)a));
}

int
gfxPrimitivesCompareInt (const void *a, const void *b)
{
  ...
  if (gfxPrimitivesFont[(unsigned char)c] == NULL)
    {
      gfxPrimitivesFont[(unsigned char)c] = SDL_CreateRGBSurface (
          SDL_SWSURFACE | SDL_HWSURFACE | SDL_SRCALPHA, 8, 8, 32, 0xFF000000,
          0x00FF0000, 0x0000FF00, 0x000000FF);
      /* Check pointer */
      if (gfxPrimitivesFont[(unsigned char)c] == NULL)
        {
...
int
characterRGBA (SDL_Surface *dst, Sint16 x, Sint16 y, char c, Uint8 r, Uint8 g,
               Uint8 b, Uint8 a)
{
  /* Draw */
...
int
stringRGBA (SDL_Surface *dst, Sint16 x, Sint16 y, char *c, Uint8 r, Uint8 g,
            Uint8 b, Uint8 a)
{
  /* Draw */
  return (stringColor (dst, x, y, c,
                       ((Uint32)r << 24) | ((Uint32)g << 16) | ((Uint32)b << 8)
                           | (Uint32)a));
}
