...
pixels. Assumes src and dst surfaces are of 8 bit depth. Assumes dst surface
was allocated with the correct dimensions.
...
*/
int
_shrinkSurfaceY (SDL_Surface *src, SDL_Surface *dst, int factorx, int factory)
{
...
*/
int
_zoomSurfaceRGBA (SDL_Surface *src, SDL_Surface *dst, int flipx, int flipy,
                  int smooth)
{
                          ...
                          double *canglezoom, double *sanglezoom)
{
  ...
  *canglezoom *= zoomx;
  ...
  dstwidthhalf
      = MAX ((int)ceil (MAX (
                 MAX (MAX (fabs (cx + sy), fabs (cx - sy)), fabs (-cx + sy)),
                 fabs (-cx - sy))),
             1);
  dstheighthalf
      = MAX ((int)ceil (MAX (
...
surface. 'angle' is the rotation in degrees and 'zoom' a scaling factor. If
...
*/
SDL_Surface *
rotozoomSurfaceXY (SDL_Surface *src, double angle, double zoomx, double zoomy,
                   int smooth)
{
  SDL_Surface *rz_src;
  SDL_Surface *rz_dst;
